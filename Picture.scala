...
object Picture {
  ...
  def flipHorizontal(img: BufferedImage): BufferedImage = {
    val image = img
  ...
  def flipVertical(img: BufferedImage): BufferedImage = {
    val image = img
  ...
  def rotateLeft(img: BufferedImage): BufferedImage = {
    val image = img
  ...
  def rotateRight(img: BufferedImage): BufferedImage = {
    val image = img
